...
const CardPost = ({
  post,
  cardPostProps: { user, isInteracting, setIsInteracting },
}) => {
  ...
  return (
    <article className="home-feed__card">
      <section
        className="home-feed__user-info"
      ...
      <p className="home-feed__post-description">
        <strong onClick={() => goToProfile(post.userId)}>{post.name} </strong>
        {post.caption}
      </p>
    </article>
  );
...
CardPost.propTypes = {
  ...
  cardPostProps: PropTypes.object.isRequired,
};
